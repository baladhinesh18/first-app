...
const marr={margin:'0 1rem 0 0 ',color:"primary"}
return(
  <div className="vacls">
  <IconButton onClick={()=>setLike(like+1)}   variant="outlined" style={marr}>👍{like}</IconButton>
  <IconButton onClick={()=>setDislike(dislike+1)}   variant="outlined" style={{color:"error"}} >👎{dislike}</IconButton>
  {/* <h1>{like}</h1> */}
  </div>
)}
