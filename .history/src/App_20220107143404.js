...
function App() {
  ...
  return (
    ...
    <h1 className="lor">Add New Movie</h1>
      ...
      <TextField id="outlined-basic" label="Enter a Movie url" variant="outlined" className="bncs" />
      <TextField id="outlined-basic" label="Enter a Movie rating" variant="outlined" className="bncs"/>
      <TextField id="outlined-basic" label="Enter a Movie summary" variant="outlined" className="bncs" />
      {/* <Counter/> */}
      </div>
