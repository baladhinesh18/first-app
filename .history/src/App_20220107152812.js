...
function App() {
  ...
  return (
    ...
    <h1 className="lor">Add New Movie</h1>
      <div  className="btn">
      <TextField id="outlined-basic" label="Enter a Movie Name" variant="outlined" value={List} onChange={(nameev)=>(nameev.target.value)} />
      <TextField id="outlined-basic" label="Enter a Movie url" variant="outlined" style={mart} value={List} onChange={(urlev)=>(urlev.target.value)} />
      <TextField id="outlined-basic" label="Enter a Movie rating" variant="outlined" style={mart} value={List} onChange={(rateev)=>(rateev.target.value)}/>
      <TextField id="outlined-basic" label="Enter a Movie summary" variant="outlined" style={mart} value={List} onChange={(sumev)=>(sumev.target.value)} />
