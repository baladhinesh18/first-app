...
function App() {
  ...
  return (
    ...
    <h1 className="lor">Add New Movie</h1>
      ...
      <TextField id="outlined-basic" label="Enter a Movie rating" variant="outlined" style={mar}/>
      <TextField id="outlined-basic" label="Enter a Movie summary" variant="outlined" style={mar} />
      <Button  variant="contained" style={mar}>Add Movie</Button>
      {/* <Counter/> */}
      </div>
