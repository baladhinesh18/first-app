...
return(
  <div>
  <Button onClick={()=>setLike(like+1)}   variant="outlined" className="vacls">👍{like}</Button>
  <Button onClick={()=>setDislike(dislike+1)}   variant="outlined" className="vacls">👎{dislike}</Button>
  {/* <h1>{like}</h1> */}
  </div>
)}
