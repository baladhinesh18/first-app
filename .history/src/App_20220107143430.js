...
function App() {
  ...
  return (
    ...
    <h1 className="lor">Add New Movie</h1>
      <div  className="btn">
      <TextField id="outlined-basic" label="Enter a Movie Name" variant="outlined" style={{margin:'1rem 0 0 0'}} />
      <TextField id="outlined-basic" label="Enter a Movie url" variant="outlined" style={{margin:'1rem 0 0 0'}} />
      <TextField id="outlined-basic" label="Enter a Movie rating" variant="outlined" style={{margin:'1rem 0 0 0'}}/>
      <TextField id="outlined-basic" label="Enter a Movie summary" variant="outlined" style={{margin:'1rem 0 0 0'}} />
      {/* <Counter/> */}
      </div>
