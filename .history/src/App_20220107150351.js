...
function App() {
  ...
  const mar={margin:'1rem 0 0 0'}
  return (
    <div className="App">
    <h1 className="lor">Add New Movie</h1>
      <div  className="btn">
      <TextField id="outlined-basic" label="Enter a Movie Name" variant="outlined"  />
      <TextField id="outlined-basic" label="Enter a Movie url" variant="outlined" style={mar} />
      ...
      <Button  variant="contained" style={{margin:'1rem 0 0 0'}}>Add Movie</Button>
      {/* <Counter/> */}
      </div>
