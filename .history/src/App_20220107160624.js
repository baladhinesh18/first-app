...
function App() {
  ...
  return (
    ...
    <h1 className="lor">Add New Movie</h1>
      <div  className="btn"  onChange={(sumev)=>setList(sumev.target.value)} >
      <TextField id="outlined-basic" label="Enter a Movie Name" variant="outlined" value={List.name} />
      <TextField id="outlined-basic" label="Enter a Movie url" variant="outlined" style={mart} value={List.url} />
      <TextField id="outlined-basic" label="Enter a Movie rating" variant="outlined" style={mart} value={List.rating} />
      <TextField id="outlined-basic" label="Enter a Movie summary" variant="outlined" style={mart} value={List.summary}/>
