...
return(
  <div>
  <Button onClick={()=>setLike(like+1)}   variant="outlined" className="varClass">👍{like}</Button>
  <Button onClick={()=>setDislike(dislike+1)}   variant="outlined" className="varClass">👎{dislike}</Button>
  {/* <h1>{like}</h1> */}
  </div>
)}
