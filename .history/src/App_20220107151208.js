...
function App() {
  ...
  return (
    ...
    <h1 className="lor">Add New Movie</h1>
      <div  className="btn">
      <TextField id="outlined-basic" label="Enter a Movie Name" variant="outlined" onChange={(nameev)=>(nameev.target.value)} />
      <TextField id="outlined-basic" label="Enter a Movie url" variant="outlined" style={mart} />
      <TextField id="outlined-basic" label="Enter a Movie rating" variant="outlined" style={mart}/>
      <TextField id="outlined-basic" label="Enter a Movie summary" variant="outlined" style={mart} />
      <Button  variant="contained" style={mart}>Add Movie</Button>
      {/* <Counter/> */}
      </div>
