...
function App() {
  ...
  return (
    ...
    <h1 className="lor">Add New Movie</h1>
      ...
      <TextField id="outlined-basic" label="Enter a Movie url" variant="outlined" style={mart} value={user.url}  onChange={(event)=>setUsers(event.target.value)}/>
      <TextField id="outlined-basic" label="Enter a Movie rating" variant="outlined" style={mart} value={user.rating}  onChange={(event)=>setUsers(event.target.value)}/>
      <TextField id="outlined-basic" label="Enter a Movie summary" variant="outlined" style={mart} value={user.summary}  onChange={(event)=>setUsers(event.target.value)}/>
